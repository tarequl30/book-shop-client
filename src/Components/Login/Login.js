...
import facebookIcon from '../../icons/fbicon.png'
...
const handleGoogleSignIn = (event) => {
    ...
    // return (
    //     <div>
    //         {/* <button onClick={handleGoogleSignIn} type="submit"><img src="" alt="google" />sign in</button> */}
    //         <form >
    //                 <div class="box">
    //                     <h1>Login</h1>
    ...
    //                     <button  class="btn" onClick={handleGoogleSignIn} type="submit"><img src="" alt="" />Sign In via google</button>
